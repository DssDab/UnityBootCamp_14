...
public class MathfSample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(("제곱근") + Mathf.Pow(pow, 0.5f));    // Mathf.Sqrt()로 계산하는 것보다 연산이 매우느림
        Debug.Log("제곱근" + Mathf.Pow(pow, -2f));     // // 2의 -2 제곱 => 1/4
