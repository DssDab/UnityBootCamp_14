...
public class MathfConstant : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // NaN에 대하여
        // 1. 두 값이 NaN일 경우 그 값에 대한 비교는 불가능합니다. (같은지 체크 하면 false)
        ...
        //                      Transform.Rotate(0,90,0) -> y축을 기준으로 90도 만큼 회전
        ...
        // 2. Mathf.Rad2Deg() : Radian(수학적으로 각도의 단위)
        //                      반지름과 같은 길이를 가진 호가 가진 중심각 = 1 라디안(57도, 약 60도)
        //                      유니티에서 제공해주는 삼각함수 계산에서 각도 대신 라디안을 요구함.
