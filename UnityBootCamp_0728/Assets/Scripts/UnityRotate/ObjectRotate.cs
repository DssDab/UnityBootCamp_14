...
// 2. 쿼터니언(Quaternion) - 회전을 계산하기에 안정적인 수학적인 박식을 가진 값
// 유니티 엔진 내부에서 실제로 저장되고 계산되는 값

// 쿼터니언으로 처리하는 이유
// 유니티에서 쿼터 --> 오릴러 각 변환 시 360도 이상의 회전은 보정될 수 있음
// 380도 회전 -> 20도 회전
...
public class ObjectRotate : MonoBehaviour
{
    void Update()
    {
        ...
        // tranform.Rotate(float x, float y, float z);  // 로컬(게임 오브젝트) 기준의 회잔
